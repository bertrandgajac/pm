...
//	m_onglets: Bloc[];
	...
	formOngletPrincipal: any=null;	//  UntypedFormGroup;
...
//console.log('retour a '+nom);
	...
	{
//console.log('onBtnDetail('+nom_btn+')');
		if(this.m_id_maitre>0)
		{
			var i:number;
			for(i=1;i<this.m_blocs.length;i++)
...
//console.log(this.m_col_detail);
	...
	onCellClickDetail(event:any)	//	appele apres un click sur une cellule d'une grille
	{
