...
import { TypeColEcran,TypeColSql,ColDef, ColonneEcran,ColonneSql,Ligne,Cellule,ColumnCbo,ColumnDate,ColumnDateHeure,ColumnVoirDoc,ColumnDefDoc,ColumnDependances,ColumnBool,ModifCol,ParamsCbo } from '../AZ_common/ecran.model';
...
//console.log('Bloc.AfficherBloc: gridApi');
