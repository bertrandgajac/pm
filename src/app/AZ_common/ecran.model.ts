...
{
	public m_ecran:any=null;
	public m_liste_items:any=null;
	public m_nom_table:string='';
	constructor(){}
	Init(ecran:Ecran,liste_items:CboListeItems,nom_table:string)
	{
		this.m_ecran=ecran;
		this.m_liste_items=liste_items;
		this.m_nom_table=nom_table;
	}
}
